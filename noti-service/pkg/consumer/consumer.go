...
func (c *EventConsumer) start(ctx context.Context, topic string, handler func(context.Context, kafkago.Message)) error {
	if c.Messaging == nil {
		return nil
	}
	...
	return client.Consume(ctx, func(msg kafkago.Message) {
		handler(ctx, msg)
	})
}

func (c *EventConsumer) handlePayment(ctx context.Context, msg kafkago.Message) {
...
func (c *EventConsumer) handleTicket(ctx context.Context, msg kafkago.Message) {
